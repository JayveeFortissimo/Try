...
const SeeBoards = () => {
  ...
  return (
    <div className="min-h-[40rem] container mx-auto p-4">
      ...
      <main className="mb-5 border min-h-[12rem] rounded p-5 flex flex-col justify-between">
        <div>
      ...
      <footer className={`grid grid-cols-1 gap-5 mt-10`}>
          {
            find?.tasks.map((pro:any) => (
              <div key={pro.board_id} className="border min-h-[8rem] rounded hover:shadow-md cursor-pointer p-4">
                   ...
                   <section className="grid grid-cols-2 md:grid-cols-4">
                       <div>
                        ...
                        <p className="text-[0.7rem] font-semibold text-gray-500">{pro?.assigned_to}</p>
                       </div>

                        <div>
                        <p className="text-sm font-semibold">Due date:</p>
                        <p className="text-[0.7rem] font-semibold text-gray-500">{pro?.due_date}</p>
                       </div>
